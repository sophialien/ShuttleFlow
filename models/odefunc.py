...
class ODEnet(nn.Module):
    ...
    def __init__(self, hidden_dims, input_shape, context_dim, player_dim, layer_type="concat", nonlinearity="softplus"):
        ...
        base_layer = {
            ...
            "concathotsquash": diffeq_layers.ConcatHotSquashLinear,
            "concathotscale": diffeq_layers.ConcatHotScaleLinear,
        }[layer_type]
        ...
        for dim_out in (hidden_dims + (input_shape[0],)):
            layer_kwargs = {}
            layer = base_layer(hidden_shape[0], dim_out, context_dim, player_dim, **layer_kwargs)
            layers.append(layer)
